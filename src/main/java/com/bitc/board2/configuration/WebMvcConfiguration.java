...
//        addResourceHandler : 스프링 내에서 사용할 폴더명 설정, 여러개의 폴더명을 설정하고자 할 경우 addResourceHandler를 여러개 사용
//        addResourceLocations : 실제 시스템 내의 폴더 위치 설정, 스프링 내에서는 1개의 폴더로 설정하고 실제 폴더는 여러개의 폴더를 등록하고자
//                               할경우 addResourceLocations()에 여러개의 경로를 입력함
